# -*- coding: utf-8 -*-
"""deep learningecg.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1sf2yt8aKdTrvWmmd_A4hl7IygsVqWDMF
"""
...
# Sample data for the metrics (you should use your actual metric values)
SSD_values_DRNN = [0.1, 0.2, 0.15]  # Replace with your actual values
MAD_values_DRNN = [0.08, 0.09, 0.12]  # Replace with your actual values
RMSE_values_DRNN = [0.15, 0.18, 0.14]  # Replace with your actual values

SSD_values_FCN_DAE = [0.12, 0.11, 0.13]  # Replace with your actual values
MAD_values_FCN_DAE = [0.09, 0.1, 0.11]  # Replace with your actual values
RMSE_values_FCN_DAE = [0.14, 0.16, 0.13]  # Replace with your actual values
...
plt.subplot(131)
plt.bar(x, SSD_values_DRNN, width=0.4, label='DRNN', align='center')
plt.bar([i + 0.4 for i in x], SSD_values_FCN_DAE, width=0.4, label='FCN-DAE', align='center')
plt.xticks([i + 0.2 for i in x], metrics)
plt.title('SSD')
plt.legend()

plt.subplot(132)
plt.bar(x, MAD_values_DRNN, width=0.4, label='DRNN', align='center')
plt.bar([i + 0.4 for i in x], MAD_values_FCN_DAE, width=0.4, label='FCN-DAE', align='center')
plt.xticks([i + 0.2 for i in x], metrics)
plt.title('MAD')
plt.legend()

plt.subplot(133)
plt.bar(x, RMSE_values_DRNN, width=0.4, label='DRNN', align='center')
plt.bar([i + 0.4 for i in x], RMSE_values_FCN_DAE, width=0.4, label='FCN-DAE', align='center')
plt.xticks([i + 0.2 for i in x], metrics)
plt.title('RMSE')
plt.legend()
...
# Given metric values
mean_RMSE_FCN_DAN = 1.859
mean_MAD_FCN_DAN = 0.429

mean_RMSE_DRNN = 3.047
mean_MAD_DRNN = 0.689
